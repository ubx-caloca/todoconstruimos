                        ...
                        <section class="col-lg-7 connectedSortable">                            
									...
									<div class="panel panel-default">
									  ...
									  <div class="panel-body">
											    ...
											    <?php foreach ($listaDeUsuarios as $usuario): ?>
											    	<div class="row">
											    		<div class="col-md-1">
											        		...
											        		<center style="padding-bottom: 15px;">{{$usuario->id}}</center>
															<center><strong><a href=" <?php echo"/administracion/usuarios/$usuario->id/edit"; ?> ">Editar</a></strong></center>
															<center>
															{{ Form::open(array('url' => '/administracion/usuarios/' . $usuario->id, 'class' => 'pull-left')) }}
											    		...
											    		<div class="col-md-11">
															<p> <img src="/images/usuarios/{{$usuario->imagen}}" alt=""  class="img-thumbnail" style="width: 150px;height: 150px;"/></p>
											        		<p><strong>Nombre:</strong> {{ $usuario->nombre }}</p>
											        		<p><strong>Email:</strong> {{ $usuario->email }}</p>
															<p><strong>Teléfono:</strong> {{ $usuario->telefono }}</p>
															<p><strong>Celular:</strong> {{ $usuario->celular }}</p>
															<p><strong>Nextel:</strong> {{ $usuario->nextel }}</p>
											...
											<center><?php echo $listaDeUsuarios->links(); ?></center>
									  </div>
									</div>
									</div>	
