                        ...
                        <section class="col-lg-12 connectedSortable">                            
                                    ...
                                    <div class="panel panel-default">
                                      ...
                                      <div class="panel-heading">
                                        <h3 class="panel-title">FOTOS PREMIUM</h3>
                                      </div>

                                    <hr>
                                        <CENTER><h2> GALERÍA DE IMAGENES </h2></CENTER>
                                    <hr>
                                    {{ Form::open(array('url' => 'administracion/proveedores/galeriapremiumautorizar')) }}
                                    @foreach ($proveedores_galeria as $foto)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <center><?php echo "<img src=\"/images/proveedores/$nombreDeUsuario/galeria/".$foto->imagen." \" alt=\"foto\" class=\"img-thumbnail\">";?></center>
                                                                ...
                                                                <br>
                                                                <center>Autorizar esta Foto a PREMIUM?: {{ Form::checkbox('premium[]', $foto->id)}} {{$leyenda}}</center> 
                                                                <br>
