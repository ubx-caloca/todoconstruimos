																	...
																	@foreach ($Eventos as $evento)
																		<div class="row text-center">
																	   	    <div class="col-md-12 service_grid">
																	   		  ...
																	   		  <p class="m_2" style="text-align:justify;"><center>{{ $evento->contenido }}</center></p>
																	          <p><br><a class="btn btn-default" href="<?php echo"/administracion/eventos/editar/$evento->id"; ?>" ><span>Editar</span></a> | <a class="btn btn-default" href="<?php echo"/administracion/eventos/borrar/$evento->id"; ?>" ><span>Borrar</span></a>
																	   		</div>
																	   	</div>
