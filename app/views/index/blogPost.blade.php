   	  ...
   	  <div class="container" style="width:100%">
   	   ...
   	   <div class="row text-center">
   	    ...
   	    <div class="col-md-8" style="padding:20px;">
   	    	...
   	    	<div class="row">
   	    		<div class="col-md-12" style="background:rgba(255,255,255,0.35);padding:20px; color:#FFF;">
   	    			<p><img src="/images/blog/{{$post->imagen}}" alt=""/></p><br>
   	    			<h4><?php echo mb_strtoupper($post->titulo,'utf8');?></h4>
