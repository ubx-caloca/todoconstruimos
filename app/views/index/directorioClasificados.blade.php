					...
					echo '<div class="container">'; //<ul style="list-style-type: none; width: 100%;">';
   	    			foreach($listaClasificadosPremium as $cat){	
					    ...
					    echo '<a href="../clasificadoDetalle/'.$cat->id.'"><div class="row" id="clasfListItem" style="padding: 10px; overflow: auto;">
								...
								<h3 style="text-align: -webkit-left;color:black">'.(($cat->premium==1)?'<img src="../images/premium.png" style="width:20px; height: 20px; float: left;"> ':' ').mb_strtoupper($cat->titulo, 'utf-8').'</h3>
								<p style="text-align: -webkit-left;font-size: smaller;font-style: normal;color: mediumblue;" > Publicado el '.date_format($tj_date, "d M Y H:i a").'</p>
