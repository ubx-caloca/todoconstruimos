...
<div style="padding-left: 3em;">		
		...
		<div class="row" style="padding-left: 0em;padding-right: 0em;">
			...
			<div class="col-md-8">
				<p style="text-align: -webkit-left;" >{{$clasificado->usuario->telefono}}</p>
			</div>
		</div>
		<div class="row" style="padding-left: 0em;padding-right: 0em;">
			<div class="col-md-4">
		...
		<div class="row" style="padding-left: 0em;padding-right: 0em;">
			...
			<div class="col-md-8">
				<p style="text-align: -webkit-left;" >{{$clasificado->usuario->nextel}}</p>
			</div>
		</div>	
		<div class="row" style="padding-left: 0em;padding-right: 0em;">
			<div class="col-md-4">
			...
			<div class="col-md-8">
				<p style="text-align: -webkit-left;" >{{$clasificado->usuario->email}}</p>
			</div>
		</div>
</div>
		<br>
