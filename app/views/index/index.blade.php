	...
	<div class="header sTop hidden-xs">
		...
		@if($username == '' || $roluser == '')
			...
			<ul id="headernav" style="float: right;list-style: none;padding-left: 25px;margin-top: 5px;padding-right: 10px;">
				...
				<div id="headeruser" style="float: right;padding-top: 3px;
max-height: 28px;">
					<input type="text" class="bginput" name="vb_login_username" id="navbar_username" size="15" accesskey="u" tabindex="101" placeholder="Usuario" style="border-radius: 3px;">
					<input type="password" class="bginput" name="vb_login_password" id="navbar_password" size="15" tabindex="102" placeholder="Contraseña" style="border-radius: 3px;">
					<input type="submit" class="button" value="Log in" tabindex="104" accesskey="s" style="border-radius: 3px;-webkit-appearance: button;color: #414042; background-color: #FCB200; background-image: linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0.05)); border: lavender; padding-left: 10px; padding-right: 10px; padding-top: 3px; padding-bottom: 3px; font-weight: 700;">
				</div>
