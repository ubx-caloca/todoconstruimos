                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-7 connectedSortable">                            
									...
									?>
											        		...
											        		<p><strong><a href=" <?php echo"/vistausuario/clasificados/$clasificado->id/edit"; ?> ">Editar</a></strong></p>
															<p>
																{{ Form::open(array('url' => '/vistausuario/clasificados/' . $clasificado->id, 'class' => 'pull-left')) }}
