                        ...
                        <section class="col-lg-7 connectedSortable">                            
                                ...
                                <div class="panel panel-default">
                                  ...
                                  <div class="panel-heading">
                                    <h3 class="panel-title">Meter datos de pago pendiente</h3>
                                  </div>
											@if ($errors->has())
                                  ...
                                  <div class="panel-body">
                                    {{ Form::open(array('url' => 'vistausuario/pagospendguardarmeterdatos', 'files' => true)) }}
										{{ Form::hidden('pagopid', $pagopid) }}
                                        ...
                                        <hr>
                                        <div class="form-group">
                                                <center>{{ Form::submit('Meter datos de pago', array('class' => 'btn btn-success')) }}</center>
                                        </div>
