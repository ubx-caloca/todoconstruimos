                        ...
                        <section class="col-lg-7 connectedSortable">                            
									...
									<div class="panel panel-default">
									  ...
									  <div class="panel-heading">
									    <h3 class="panel-title">EDITAR INFORMATION DE USUARIO</h3>
									  </div>
										@if ($errors->has())
									...
									<p><strong>Errores:</strong> </p>
									 ...
									 {{ Form::model($usuario, array('route' => array('vistausuario.usuarios.update', $usuario->id), 'method' => 'PUT',  'files'=> true)) }}
											<hr>
											...
											<div class="form-group">
													{{ Form::label('user_password', 'Contraseña actual (Introducir en caso de cambiar a una nueva contraseña)') }}
													@if ($errors->has())
														{{ Form::password('user_oldpassword', array( 'placeholder' => '',  'class' => 'form-control')) }}
													@else
														{{ Form::password('user_oldpassword', array( 'placeholder' => '',  'class' => 'form-control')) }}
													@endif
											</div>
