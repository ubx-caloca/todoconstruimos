						...
						<div class="container small gallery">
							...
							@foreach ($galeria as $foto)
								<div class="row flush images">
									<div class="12u"><a href="/images/proveedores/{{ $proveedores->nombre_usuario }}/galeria/{{ $foto->imagen }}" class=" l"><img src="/images/proveedores/{{ $proveedores->nombre_usuario }}/galeria/{{ $foto->imagen }}" title="" alt="" /></a></div>
								</div>							
							@endforeach
						</div>
