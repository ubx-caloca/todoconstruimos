...
class ClasificadosController extends \BaseController {
	...
	public function create()
	{
		...
		return View::make('administracion.pages.clasificados.nuevo')->with(array('listaCategoriasClasificados'=>$listaCategoriasClasificados, 'usuarioimg'=>$authuser->imagen, 'usuarionombre'=>$authuser->nombre, 'usuarioid'=>$authuser->id, 'latitud_ens'=>$latitud_ens, 'longitud_ens'=>$longitud_ens));
	}
	...
	public function edit($id)
	{
		...
		$listaCategoriasClasificados = array('NA' => 'Elige una categoria para el clasificado')+ClasificadoCategoria::lists('categoria','id');
		return View::make('administracion.pages.clasificados.editar')->with(array('listaCategoriasClasificados'=>$listaCategoriasClasificados, 'clasificado'=>$clasificado, 'imagenes'=>$imgg, 'usuarioimg'=>$authuser->imagen, 'usuarionombre'=>$authuser->nombre, 'usuarioid'=>$authuser->id, 'latitud_ens'=>$latitud_ens, 'longitud_ens'=>$longitud_ens));		
		//
	}
