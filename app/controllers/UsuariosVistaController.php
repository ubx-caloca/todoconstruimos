...
class UsuariosVistaController extends \BaseController {
	...
	{
		//
		return 'Soy UsuariosVistaController.index()';
	}
	...
	{
		//
		return 'Soy UsuariosVistaController.create()';
	}
	...
	{
		//
		return 'Soy UsuariosVistaController.store()';
	}
	...
	{
		//
		return 'Soy UsuariosVistaController.show('.$id.')';
	}
	...
	public function edit($id)
	{
		...
		return View::make('vistausuario.pages.usuarios.editar')->with(array('usuario'=>$usuario, 'usuarioimg'=>$authuser->imagen, 'usuarionombre'=>$authuser->nombre, 'usuarioid'=>$authuser->id));	
	}
	...
	public function update($id)
	{
		...
		if ($validator->fails()) {
			return Redirect::to('vistausuario/usuarios/'.$id.'/edit')
	...
	{
		//
		return 'Soy UsuariosVistaController.destroy('.$id.')';
	}
